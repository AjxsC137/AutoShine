...
[View Live Demo](https://auto-shine-4wikik2qh-ajits-projects-98f27314.vercel.app)
...
Seamlessly switch between Dark and Light modes. The 3D scene environment, including fog and lighting, updates in real-time to match the UI.

📱 Precision-Engineered Responsive Design
A custom layout that adapts perfectly to mobile. On smaller screens, the 3D viewport adjusts its scale to maintain visual impact.
...
Direct "One-Tap" booking links for WhatsApp and Instagram, pre-filled with customer inquiries.
...
Bash
git clone https://github.com/your-username/autoshine.git
cd autoshine
Asset Placement
...
Optimized Rendering: The site uses an IntersectionObserver to pause 3D rendering when a section is not visible, reducing hardware strain.
